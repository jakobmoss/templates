...
%%                                           %%
%%   Time-stamp: <2016-03-30 10:34:56 moss>  %%         
%%                                           %%
%%              Made for pdfLaTeX            %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Units
\usepackage{siunitx, mathabx}
\sisetup{separate-uncertainty=true}
\DeclareSIUnit\au{AU}
\DeclareSIUnit\year{Yr}
\DeclareSIUnit\erg{erg}
\DeclareSIUnit\msun{M_{\Sun}}
\DeclareSIUnit\lsun{L_{\Sun}}
...
\newcommand\upmean[1]{\ensuremath{\norm{#1}_{\textup{up}}}\xspace}
\newcommand\dnmean[1]{\ensuremath{\norm{#1}_{\textup{dn}}}\xspace}
